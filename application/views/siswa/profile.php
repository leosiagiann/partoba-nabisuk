    ...
    <div class="row">
        <section class="section col-md-7">
            ...
            <div class="section-body">
                <div class="card p-3">
                    <p class="text-center">
                        <img src="<?= base_url('assets/upload/siswa/thumbs/' . $foto);
                                    ?>" style="max-width: 150px; height: auto;" class="img img-circle img-thumbnail">
                    </p>
                    <form method="post" enctype="multipart/form-data" action="<?= base_url('siswa/profile') ?>">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label text-right">Nama Siswa <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="nama" id="nama" class="form-control"
                                    placeholder="Nama Pengguna" value="<?= $nama ?>" onkeyup="s_()">
        ...
        <section class="section col-md-5">
            ...
            <div class="section-body">
                <div class="card p-3">
                    <form method="post" action="<?= base_url('siswa/gantipassword') ?>">
                        <div class="form-group row">
...
<script src="<?= base_url('assets/js/self/pf-3.js'); ?>"></script>
...
if ($this->session->flashdata('edit-password-siswa')) {
?>
<script>
Swal.fire({
    icon: 'success',
...
if ($this->session->flashdata('edit-profil-siswa')) {
?>
<script>
Swal.fire({
    icon: 'success',
