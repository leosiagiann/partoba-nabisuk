                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="custom-select" name="jadwal" id="jadwal">
                                    ...
                                    <option value="senin 15:00, rabu 15:00" selected>Senin 15:00, Rabu 15:00</option>
                                    <?php else : ?>
                                    <option value="senin 15:00, rabu 15:00">Senin 15:00, Rabu 15:00</option>
                                    <?php endif; ?>
                                    <?php if (strcmp($k->jadwal, "selasa 15:00, rabu 15:00") == 0) : ?>
                                    <option value="selasa 15:00, rabu 15:00" selected>Selasa 15:00, Rabu 15:00</option>
                                    <?php else : ?>
                                    ...
                                    <option value="jumat 13:00, sabtu 15:00" selected>Jumat 13:00, Sabtu 15:00</option>
                                    <?php else : ?>
